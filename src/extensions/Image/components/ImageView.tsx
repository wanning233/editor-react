...
import { Image as AntdImage, Tooltip } from 'antd'; // Import antd components
import { IMAGE_MAX_SIZE, IMAGE_MIN_SIZE, IMAGE_THROTTLE_WAIT_TIME } from '../../../components/constants';
